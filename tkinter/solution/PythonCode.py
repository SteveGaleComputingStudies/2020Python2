...
def onClickSubmitButton():                      # submit button event handler
        ...
        # if definition in python_dictionary:   # alternative to try / except
        #  definition = python_dictionary[userEnteredText]
        # else:
        #  definition = " no match for key value entered"
...
photo = PhotoImage(file="C:/Users/sgale/OneDrive/2020-Teaching/Python ADCSE2/code/tkinter/solution/me.gif")
...
outputTextField.grid(row=5, column=0,sticky=W)  # grid position of textField
