#FROM C:\Users\sgale\OneDrive\2020-Teaching\Python ADCSE2\code\tkinter\2F-plotPandasDataFrameExcelRoomDataFilter.py
...
print(dfE208Temp)
dfE208Temp.plot(x ='Time', y='Temperature', kind = 'line')

#E222
dfE222Temp = df[df["Room"] == "E222"]
print(dfE222Temp)
# ORDER BY Time ACSENDING
dfE222tempSorted = dfE222Temp.sort_values("Time")
print(dfE222tempSorted)

dfE222tempSorted.plot(x ='Time', y='Temperature', kind = 'bar')
